...
- **Waleed Kadous (@waleedkadous)** — symmetric hot/cold governance docs: shipped Spec 987 (PR #1034), splitting `arch.md` and `lessons-learned.md` into hard-capped always-injected hot tiers plus on-demand cold reference archives, with the materializer that makes them appear on init / adopt / update. The architectural foundation for the cycle's fresh-install fixes (#1011, #1012).
