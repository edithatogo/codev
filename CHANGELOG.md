...
- **Graceful-restart persistence for siblings**: `afx workspace stop` + `afx workspace start` preserves sibling architect registrations. `afx tower stop` and crash recovery already worked; this completes the matrix.
