...
- **Internal Systems** (all post-#786):
  ...
  - **Item 3**:
    ...
    - Both files are referenced by the spawn prompt at `packages/codev/src/agent-farm/spawn.ts:448, :515, :520, :817` (`"You are a Builder. Read codev/roles/builder.md for your full role definition"`), so the instruction reaches every spawned builder at session start.
  - **Item 4**:
